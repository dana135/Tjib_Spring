...
public class Venue {
	...
	public Venue(String venueName, ArrayList<String[]> seats, String location, int capacity) {
	...
	public void addBulkSeats(ArrayList<String[]> seats) {
		for(String[] s : seats) addSeats(s);
	}
